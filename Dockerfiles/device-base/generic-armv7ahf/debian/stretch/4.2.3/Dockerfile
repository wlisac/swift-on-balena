# Autogenerated device Dockerfile based on architecture Dockerfile: wlisac/armv7hf-debian-swift:4.2.3-stretch

# wlisac/generic-armv7ahf-debian-swift:4.2.3-stretch
