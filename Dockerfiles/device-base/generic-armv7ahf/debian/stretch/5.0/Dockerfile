# Autogenerated device Dockerfile based on architecture Dockerfile: wlisac/armv7hf-debian-swift:5.0-stretch

# wlisac/generic-armv7ahf-debian-swift:5.0-stretch
