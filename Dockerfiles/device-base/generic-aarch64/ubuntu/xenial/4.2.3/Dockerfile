# Autogenerated device Dockerfile based on architecture Dockerfile: wlisac/aarch64-ubuntu-swift:4.2.3-xenial

# wlisac/generic-aarch64-ubuntu-swift:4.2.3-xenial
